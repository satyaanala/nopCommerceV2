...
public WebDriver ldriver;
	...
	By lnkCustomers_menu=By.xpath("//a[@href='#']//span[contains(text(),'Customers')]");  //for customer
	...
	public void clickOnCustomersMenu() {               //action methods
...
public void setCustomerRoles(String role) 
	{
		...
		switch(role)      //role is not a single one
		{
		case "Administrators":
		...
		//listitem.click();  sometimes it wont work out
